...
public class ShopAdapterUser extends RecyclerView.Adapter<ShopAdapterUser.MyViewHolder> {
    ...
    public ShopAdapterUser(Context context, List<Shop> shopList, OnItemClickListener listener) {

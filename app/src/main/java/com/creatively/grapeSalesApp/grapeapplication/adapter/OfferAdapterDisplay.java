...
public class OfferAdapterDisplay extends RecyclerView.Adapter<OfferAdapterDisplay.MyViewHolder> {
    ...
    public OfferAdapterDisplay(Context context, List<Offer> offerList, OnItemClickListener listener) {
